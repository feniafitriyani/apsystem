    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Tambah Siswa</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
				  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">No.Kartu</label>
          		  ...
          		  <div class="form-group">
                  	<label for="firstname" class="col-sm-3 control-label">NIS</label>
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">Kontak Orang Tua</label>
                ...
                <div class="form-group">
                    <label for="position" class="col-sm-3 control-label">Kelas</label>
                      ...
                      <select class="form-control" name="position" id="position" required>
                        ...
                        <?php
                          ...
                          while($prow = $query->fetch_assoc()){
                            echo "
                              <option value='".$prow['id']."'>".$prow['kelas']."</option>
                            ";
                          }
                        ?>
                      </select>
                ...
                <div class="form-group">
                    <label for="schedule" class="col-sm-3 control-label">Jadwal</label>
          	...
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Keluar</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_contact" class="col-sm-3 control-label">Kontak Orang Tua</label>
                ...
                <div class="form-group">
                    <label for="edit_position" class="col-sm-3 control-label">Kelas</label>
                ...
                <div class="form-group">
                    <label for="edit_schedule" class="col-sm-3 control-label">Jadwal</label>
          	...
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Keluar</button>
            	<button type="submit" class="btn btn-success btn-flat" name="edit"><i class="fa fa-check-square-o"></i> Ubah</button>
            	</form>
          	</div>
        </div>
    </div>
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Keluar</button>
              <button type="submit" class="btn btn-success btn-flat" name="upload"><i class="fa fa-check-square-o"></i> Ubah</button>
              </form>
            </div>
        </div>
    </div>
