                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      $status = ($row['status'])?'<span class="label label-warning pull-right">ontime</span>':'<span class="label label-danger pull-right">Terlambat</span>';
                      echo "
                        <tr>
                          <td class='hidden'></td>
                          ...
                          <td>
                            ...
                            <button class='btn btn-danger btn-sm btn-flat delete' data-id='".$row['attid']."'><i class='fa fa-trash'></i> Hapus</button>
                          </td>
                        </tr>
                      ";
                    }
